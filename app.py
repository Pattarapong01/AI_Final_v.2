...
def call_stylist_ai(prompt, context_products, chat_history_list, user_profile):
    ...
    4. ถ้า ลูกค้าถาม เช่น อยากได้กางเกง ให้ตอบเฉพาะ ที่อยู่ใน Category Pants เท่านั้น 
    5. ถ้า ลูกค้าถาม เช่น อยากได้เสื้อ ให้ตอบเฉพาะที่อยู่ใน Category T-Shirt เท่านั้น เท่านั้น
    6. ถ้า ลูกค้าถาม เช่น อยากได้ชุดกีฬา ให้ตอบเฉพาะ Category Sport เท่านั้น เท่านั้นเท่านั้น
    7. ถ้า ลูกค้าถาม เช่น อยากได้เสื้อฮู๊ด ให้ตอบเฉพาะ  Category Hoodie เท่านั้น เท่านั้นเท่านั้น
    8. ตอบเฉพาะ ภาษาไทย อย่างเดียว ทุกคำถาม
...
def ai_generate_post():
    try:
        ...
        ใช้ภาษาไทยเท่านั้น ที่ดูเท่ ทันสมัย  ใส่ Emoji และ Hashtag
        """

...
def call_stylist_ai(prompt, context_products, chat_history_list, user_profile):
    ...
    4. ถ้า ลูกค้าถาม เช่น อยากได้กางเกง ให้ตอบเฉพาะกางเกงเท่านั้น 
    5. ถ้า ลูกค้าถาม เช่น อยากได้เสื้อ ให้ตอบเฉพาะเสื้อเท่านั้น
    6. ถ้า ลูกค้าถาม เช่น อยากได้ชุดกีฬา ให้ตอบเฉพาะชุดกีฬาเท่านั้น
    7. ถ้า ลูกค้าถาม เช่น อยากได้เสื้อฮู๊ด ให้ตอบเฉพาะเสื้อฮู๊ดเท่านั้น
    8. ตอบเฉพาะ ภาษาไทย อย่างเดียว
...
def ai_generate_post():
    try:
        ...
        ใช้ภาษาไทยอย่างเดียว ที่ดูเท่ ทันสมัย ใส่ Emoji และ Hashtag
        """
